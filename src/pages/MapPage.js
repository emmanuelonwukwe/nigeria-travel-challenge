  ...
  return (
    <section>
      ...
      <section className="Map-container">
        ...
        <section className="Map-cta">
          <section className="Map-cta-button-container">
            <button className="save-image-button" onClick={downloadJpg}>
              Save Image
            </button>
            <button
              className="reset-button"
              onClick={handleReset}
              disabled={noProvinceSelected}
            >
              Reset
            </button>
          </section>
        ...
        <div className="donate-button">
          ...
          >
            ...
            <input
              ...
              border="0"
              name="submit"
              title="Contact me for modification"
      ...
      {isResetMapToastVisible && (
        <div className="Map-cta-toast">Map has been reset</div>
      )}
    </section>
  );
}
